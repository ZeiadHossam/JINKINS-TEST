/*   |   *//************** TAFJ INFO ***************************************/
/*   |   *//* <TAFJ-BP>C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\Maven Test3\\MavenTestTarshV1-data-code\\src\\Source\\EB_MavenTestTarshV1\\Definition\\EB.MavenTestTarshV1.component<\TAFJ-BP>  */
/*   |   *//* <TAFJ-BPA><\TAFJ-BPA>  */
/*   |   *//* <TAFJ-BN>component.EB.MavenTestTarshV1<\TAFJ-BN>  */
/*   |   *//************** TAFJ INFO ***************************************/
...
/*   |   */import com.temenos.tafj.common.exception.BasicErrors;
/*   |   */import com.temenos.tafj.common.exception.SessionExpirationException;
...
/*   |   */
/*   |   */ //COMPONENTDEF component_EB_MavenTestTarshV1_20_cl
/*   |   */@SuppressWarnings("unused")
/*   |   */public class component_EB_MavenTestTarshV1_20_cl extends jRunTime {
...
/*   |   */    
/*   |   */    public component_EB_MavenTestTarshV1_20_cl(jSession session) { // constructor
/*   |   */        this.session = session;
/*   |   */        super.init(session);
/*   |   */        this.TF_Core = new TF_Core(this);
/*   |   */        this.TF_ErrorHandling = new TF_ErrorHandling(this);
/*   |   */    }
/*   |   */    public component_EB_MavenTestTarshV1_20_cl() { // empty constructor for introspection
/*   |   */        this.session = null;
/*   |   */        this.TF_Core = null;
...
/*   |   */    
/*   |   */    
/*   |   */    public jVar EBVFtValidation() {
/*   |   */          if (jRunTime.logComponentUsageEnabled(session)){
/*   |   */               jRunTime.logComponentUsage(this.session, "EB.MavenTestTarshV1", "METHOD", "EBVFtValidation", "EB.V.FT.VALIDATION");
/*   |   */          }
/*   |   */          if (this.session.isUnitTest()) {
/*   |   */              return this.session.findStub("EB.MavenTestTarshV1.EBVFtValidation", "EB.V.FT.VALIDATION").invoke();
/*   |   */          } else {
/*   |   */              jRunTime jrt = EB_V_FT_VALIDATION_cl.INSTANCE(this.session);
/*   |   */              jVar ret = jrt.invoke();
/*   |   */    	       return ret;
/*   |   */          }
/*   |   */    }
/*   |   */    
/*   |   */    public static jVar EBVFtValidation_isImplemented(){
/*   |   */       try{
/*   |   */            Class<?> jBCClass = Class.forName("com.temenos.t24.EB_V_FT_VALIDATION_cl");
/*   |   */            return jVarFactory.get("1" + sFM + "EB.V.FT.VALIDATION");
/*   |   */        }catch(Throwable t){
/*   |   */            // Stay quite 
/*   |   */        }
/*   |   */        return jVarFactory.get("0" + sFM + "EB.V.FT.VALIDATION");
/*   |   */    }
/*   |   */    
/*   |   */    //
...
/*   |   */        try {
/*   |   */            Method met = component_EB_MavenTestTarshV1_20_cl.class.getDeclaredMethod(sSubroutine, new Class[] {Object.class });
...
/*   |   */        ret[0] = "EB.V.FT.VALIDATION";
/*   |   */        return ret;
/*   |   */    }
/*   |   */    
/*   |   */    //For Debugger and tShow
/*   |   */    public String getPathFileNameBasic(){
/*   |   */        return "C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\Maven Test3\\MavenTestTarshV1-data-code\\src\\Source\\EB_MavenTestTarshV1\\Definition\\EB.MavenTestTarshV1.component";
/*   |   */    }
/*   |   */    
/*   |   */    //static method
...
/*   |   */        return "1701806654068	05 Dec 2023 22:04:14	ZeyadZikry	3";
/*   |   */    }
/*   |   */    
/*   |   */    // static method
...
/*   |   */        return "eNoVjDsOwjAMQHefwiMskbowsLVApUp8lsi7aSw1KImrxrAg7k47v8+oedYixfDSuRt/pHip5nmpEzWQxThrkESy1KgFG3cAmN/PFEdc4aRh7ag34hQD26bsYA9fQMRXdzpuV3K9d9Reh3Prh8cdfvAHU6UlTA==";
/*   |   */    }
/*   |   */
/*   |   */}
